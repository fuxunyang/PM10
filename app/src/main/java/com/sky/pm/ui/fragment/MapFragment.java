...
public class MapFragment extends BaseFragment {
    ...
    BitmapDescriptor bdA = BitmapDescriptorFactory
            .fromResource(R.drawable.ic_pie1);
    BitmapDescriptor bdB = BitmapDescriptorFactory
            .fromResource(R.drawable.ic_pie2);
    BitmapDescriptor bdC = BitmapDescriptorFactory
            .fromResource(R.drawable.ic_pie3);
    BitmapDescriptor bdD = BitmapDescriptorFactory
            .fromResource(R.drawable.ic_pie4);
                ...
                case 1:
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if (value >= 0 && value <= 50) {
                            ...
                            MarkerOptions ooB = new MarkerOptions().position(ll).icon(bdB)
                                    .zIndex(5);
                            mBaiduMap.addOverlay(ooB);
                        } else if (value >= 101 && value <= 150) {
                            MarkerOptions ooC = new MarkerOptions().position(ll).icon(bdC)
                                    .zIndex(7);
                            mBaiduMap.addOverlay(ooC);
                        } else if (value >= 151) {
                            MarkerOptions ooD = new MarkerOptions().position(ll).icon(bdD)
                                    .zIndex(0);
